...
public class GrapheTest
{
	...
	public void testGraphe()
	{
		...
		GrapheNonValue<Integer> G1=Factory.grapheNonValue(G);
	...
	{
		Sommet<Integer> es=Factory.sommet(100);
	...
	{
		Arc<Integer> ea=Factory.arcNonValue(s4,s1);
	...
	public void testAjouteSommet()
	{
		...
		Sommet<Integer> s6=Factory.sommet(5);
		G.ajouteSommet(s5);
		G.ajouteSommet(6);
	...
	{
		Sommet<Integer> s5=Factory.sommet(5);
		Arc<Integer> a51=Factory.arcNonValue(s5,s1);
		Arc<Integer> a41=Factory.arcNonValue(s4,s1);
		G.ajouteArc(a51);
		G.ajouteArc(4,1);
		G.ajouteArc(s3,s1);
		G.ajouteArc(a32);
	...
	{
		GrapheNonValue<Integer> Ge=Factory.grapheNonValue();
	...
	public void testCorrectGamma()
	{
		...
		EnsembleSommet<Integer> x=Factory.ensembleSommet();
		x.ajouteElement(s1);
		x.ajouteElement(s2);
	...
	{
		EnsembleSommet<Integer> Pe=Factory.ensembleSommet();
		Pe.ajouteElement(s1);
	...
	public void testPointsSortie()
	{
		...
		G.ajouteSommet(s5);
		G.ajouteArc(s4,s5);
		EnsembleSommet<Integer> Ps=Factory.ensembleSommet();
		Ps.ajouteElement(s5);
	...
	{
		Sommet<Integer> s5=Factory.sommet(5);
		Arc<Integer> a15=Factory.arcNonValue(s1,s5);
		GrapheNonValue<Integer> Gajout=Factory.grapheNonValue();
		Gajout.ajouteSommet(s1);
		Gajout.ajouteSommet(s5);
		Gajout.ajouteArc(a15);
		Gajout=GrapheNonValue.union(Gajout,G);
		GrapheNonValue<Integer> Gunion=Factory.grapheNonValue(G);
	...
	public void encapsulation()
	{
		...
		EnsembleSommet<Integer> Xg=G.getEnsembleSommet();
		Xg.supprElement(s3);
		...
		GrapheNonValue<Integer> G2=Factory.grapheNonValue(G);
		G2.supprArc(a12);
	...
	public void testEquals()
	{
		...
		GrapheNonValue<Integer> graphe=Factory.grapheNonValue(G);
