...
public class CalculCFCTest
{
	...
	private Arc<Integer> a12, a23, a32, a34, a41;
	...
	public void setUp()
	{
		...
		ES23.ajouteElement(s2);
		ES23.ajouteElement(s3);
		CFCres1.replace(s2,ES23);
		CFCres1.replace(s3,ES23);
		...
		ES1234.ajouteElement(s1);
		ES1234.ajouteElement(s2);
		ES1234.ajouteElement(s3);
		ES1234.ajouteElement(s4);
		CFCres2.replace(s1,ES1234);
		CFCres2.replace(s2,ES1234);
		CFCres2.replace(s3,ES1234);
		CFCres2.replace(s4,ES1234);
	}
	@Test
