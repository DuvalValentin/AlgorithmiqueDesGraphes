...
public class FermetureTransitiveTest
{
	...
	public void testPuissanceGraphe()
	{
		...
		InterfaceGrapheValue<Integer> PGV = (InterfaceGrapheValue<Integer>) FermetureTransitive.puissanceDeGraphe(GV);
		assertEquals(GVT,PGV,"La puissance de graphe ne marche pas");
	}
	@Test
	public void testRoy_Warshall()
	{
		InterfaceGrapheNonValue<Integer>RW=(InterfaceGrapheNonValue<Integer>)FermetureTransitive.royWarshall(G);
		assertEquals(GT,RW,"Roy_Warshall ne marche pas");
		
		InterfaceGrapheValue<Integer>RWV=(InterfaceGrapheValue<Integer>) FermetureTransitive.royWarshall(GV);
