...
public class AntiTransitifTest
{
	...
	private Arc<Integer> a12, a13, a14, a23, a24, a34;
	private GrapheNonValue<Integer> Gini, Gres;
	...
	void setUp() throws Exception
	{
		...
		Gres.ajouteSommet(s1);
		Gres.ajouteSommet(s2);
		Gres.ajouteSommet(s3);
		Gres.ajouteSommet(s4);
		Gres.ajouteArc(a12);
		Gres.ajouteArc(a23);
		Gres.ajouteArc(a34);
