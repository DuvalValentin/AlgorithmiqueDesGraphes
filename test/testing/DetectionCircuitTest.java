...
public class DetectionCircuitTest
{
	...
	private Arc<Integer> a12, a23, a32, a34;
	private GrapheNonValue<Integer> Gcirc, Gline;
	...
	public void setUp()
	{
		...
		Gline.ajouteSommet(s1);
		Gline.ajouteSommet(s2);
		Gline.ajouteSommet(s3);
		Gline.ajouteSommet(s4);
		Gline.ajouteArc(a12);
		Gline.ajouteArc(a23);
		Gline.ajouteArc(a34);
